...
ORM — это техника программирования, которая позволяет взаимодействовать с реляционными базами данных в терминах объектно-ориентированных объектов. Она скрывает подробности SQL-запросов, позволяя работать с таблицами реляционной базы данных как с обычными Java-классами, 
